...
console.log("odas as idades:", idades)
...
console.log ("--- Exemplo 2:filter cadastros ativos (intermediário) ---");
...
// Regra de Negócio: Listar somente periféricos que estejam ativos e tenham unidads em estoque
const perifericosDisponiveis = catalogo.filter((item) => {
    return item.categoria === "Periféricos" && item.ativos && item.estoque >0;
});
